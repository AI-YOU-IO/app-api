...
→ Responder con el siguiente formato:

> "Te comparto el link para la actualización de tu tarjeta: [link de cambio de tarjeta]
>
> Al ingresar, solo necesitas digitar tu grupo familiar {{grupo_familiar}} y tu DNI.
>
> Si necesitas ayuda en algún paso, estoy aquí para apoyarte 👍"
...
> "Gracias por la validación, ¿te puedo enviar el link para actualizar tu tarjeta y así garantizar que los próximos cobros se realicen correctamente?"
  ...
  - **Sí** → Utilizar tool: obtenerLinkCambio({{grupo_familiar}}) → Responder con: "Te comparto el link para la actualización de tu tarjeta: [link de cambio de tarjeta]. Al ingresar, solo necesitas digitar tu grupo familiar {{grupo_familiar}} y tu DNI. Si necesitas ayuda en algún paso, estoy aquí para apoyarte 👍" → Preguntar: "¿Desea realizar el pago ahora?"
...
- **Sí** → Utilizar tool: obtenerLinkCambio({{grupo_familiar}}) → Responder con: "Te comparto el link para la actualización de tu tarjeta: [link de cambio de tarjeta]. Al ingresar, solo necesitas digitar tu grupo familiar {{grupo_familiar}} y tu DNI. Si necesitas ayuda en algún paso, estoy aquí para apoyarte 👍" → Ir a 7. Despedida
- **No** → Ir a 7. Despedida
