...
const chatIndicadoresRoutes = require("./routes/crm/chat_indicadores.route.js");
const app = express();
...
app.use("/api/crm", authMiddleware, configuracionRoutes, llamadaRoutes, tipificacionLlamadaRoutes, personaRoutes, whatsappRoutes, transcripcionRoutes, configuracionWhatsappRoutes, consumoIndicadoresRoutes, chatIndicadoresRoutes);
