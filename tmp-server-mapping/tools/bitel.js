const bitelTools = [
  ...
  },
  {
    temporaryTool: {
      ...
      description: "Busca sucursales cercanas al cliente. La búsqueda compara ÚNICAMENTE contra departamento, provincia y distrito (NO contra dirección ni nombre). Formato requerido del término: 'departamento-provincia-distrito' (ej: 'lima-lima-san isidro', 'arequipa-arequipa-cerro colorado'). Devuelve máximo 3 sucursales ordenadas por match, con id, nombre, dirección, teléfono, email, estado, provincia y ciudad.",
      timeout: "5s",
      http: {
